...
public class CheckoutPage {
	...
	public static boolean getClickCheckout(WebDriver driver) {
		...
		try {
			...
			Logging.error("Could not Click on Checkout Button");
			flag = false;
		}
		return flag;
	}
	...
	public static boolean getDetails(WebDriver driver) throws IOException {
		...
		try {
			...
			flag = true;
			Logging.info("Details filled on Address Page");
		}
		catch(Exception e) {
			Logging.error("Could not fill details on Address Page");
			flag = false;
		}
		return flag;
	}
	...
	public static boolean getSave(WebDriver driver) {
		...
		try {
			...
			flag = true;
			Logging.info("Save and Continue Clicked");
		}
		catch(Exception e) {
			Logging.error("Could not click on Save and Continue");
			flag = false;
		}
		return flag;
	}
	...
	public static boolean getHome(WebDriver driver) {
		...
		try {
			...
			flag = true;
			Logging.info("Home Page Clicked on Checkout");
		}
		catch(Exception e) {
			flag = false;
			Logging.error("Could not click on Homepage on Checkout");
